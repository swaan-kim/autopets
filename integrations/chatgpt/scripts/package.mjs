...
export async function packageChatGPT({out=join(root,'release/chatgpt'),node=null,nodeLicense=null}={}){
 ...
 const runtimeFiles={guidance:['index.mjs','recipes.mjs','injection.mjs','routing.mjs','quality.mjs'],contracts:['index.mjs','constants.mjs','validation.mjs','identity.mjs','context.mjs','preferences.mjs']};
