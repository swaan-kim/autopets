...
export function PetQuickCard({ title, help, goal, constraints = [], currentStep, task, defaultWorkStyle, assistanceEnabled, busy = false, disabled = false, error, notice, returnLabel = '작업으로 돌아가기', onReturn, onWorkStyle, onDetails, onToggleAssistance, onHide, onQuit, onClose }: PetQuickCardProps) {
  const [more, setMore] = useState(false);
  const taskKey = task ? identityKey(task.identity) : '';
